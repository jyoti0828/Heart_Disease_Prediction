...
def app():
    ...
    st.write(
        "Please input the following parameters to predict the presence of heart disease:"
    )
    ...
    oldpeak = st.slider(
        "ST Depression Induced by Exercise Relative to Rest", 0.0, 6.0, 3.0, 0.1
    )
    ...
    if st.button("Predict"):
        ...
        if result == 0:
            ...
            st.write(
                "Heart Disease Detected for the Person!! Consult Doctor Immediately "
            )
